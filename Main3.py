        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
            ...
            if capture_image:  # This block will execute if capture_image is True
                ...
                if not listOfPossiblePlates:  # if no plates were found
                    ...
                    if not licPlate.strChars:  # if no chars were found in the plate
                        print("\nno characters were detected\n\n")  # show message
                        continue  # go back to start of the loop for new detection
            ...
            if key == ord("q"):
                return  # This return is correctly inside the main() function
...
def scan_devices():
    ...
    while True:
        ...
        #time to wait before send again the list of bt devices
